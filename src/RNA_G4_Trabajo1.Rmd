...
guardar_gif_colonia()
```
```{r fig.cap="**Fig 22.** *Mejor Ruta usando Colonia de Hormigas*", fig.align="center", out.width="70%"}
knitr::include_graphics("ruta_colonia_hormigas.gif")
```

```{r fig.cap="**Fig 23.** *Mejor Ruta usando K-Vecino más cercano*", fig.align="center", out.width="70%"}
